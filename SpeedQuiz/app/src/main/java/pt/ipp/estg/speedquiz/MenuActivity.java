...
private List<pt.ipp.estg.speedquiz.Utilizador> utilList;
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        utilizadorViewModel.getUtilizadorList().observe(this, new Observer<List<pt.ipp.estg.speedquiz.Utilizador>>() {
                @Override
